...
function Shirt(props) {
  ...
  return (
    <mesh rotation={[0, 1, 1]} castShadow geometry={nodes.T_Shirt_male.geometry} material={materials.lambert1} material-roughness={1} {...props} dispose={null}>
      <Decal position={[0, 0.04, 0.15]} rotation={[0, 0, 0]} scale={0.3} map={texture} map-anisotropy={16} />
    </mesh>
  )
}
